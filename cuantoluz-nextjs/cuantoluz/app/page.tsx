...
import {
  appliances, cars, FAST_CHARGE_PRICE, GASOLINE_PRICE_PER_LITER,
  GASOLINE_CONSUMPTION_L_PER_100, fmt, fmtE, fmtMoney, h, hm,
  color, semClass, statusLabel, getPriceAtHour, calculateCyclePrice,
  PriceData
} from '@/lib/utils';
...
export default function Home() {
  ...
  return <Calculator prices={prices} currentHour={currentHour} />;
}

function Calculator({ prices, currentHour }: { prices: PriceData[]; currentHour: number }) {
      ...
      <div className="hero-action">
        <div className="hero-grid">
          <div className="hero-block">
            ...
            <div className="hero-price" style={{ color: color(cur.price) }}>
              {fmt(cur.price)}
          ...
          <div className="hero-block divider">
            ...
            <div className="hero-price" style={{ color: 'var(--green-bright)', fontSize: 'clamp(36px,5vw,56px)' }}>
              {h(minP.hour)}
            </div>
            <div className="hero-unit">{fmt(minP.price)} c€/kWh · {fmtE(minP.price)} €/kWh</div>
            <div className="hero-saving">
              <span className="saving-pct">−{savingPct}%</span>
              <span>de ahorro frente al precio actual</span>
            </div>
          </div>
          ...
          <div className="hero-block divider">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '14px' }}>
              <div>
                ...
                <div style={{ fontFamily: 'Syne', fontSize: '18px', fontWeight: 700, color: 'var(--green-bright)' }}>{fmt(minP.price)} c€</div>
              ...
              <div>
                ...
                <div style={{ fontFamily: 'Syne', fontSize: '18px', fontWeight: 700, color: 'var(--yellow)' }}>{fmt(avg)} c€</div>
              ...
              <div>
                ...
                <div style={{ fontFamily: 'Syne', fontSize: '18px', fontWeight: 700, color: 'var(--red)' }}>{fmt(maxP.price)} c€</div>
